        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nr_domu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    nr_mieszkania = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nazwa_alergenu = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    opis_alergenu = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nazwa_kategorii = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    nazwa_uzytkownika = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    haslo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    telefon = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    typ_uzytkownika = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    nazwa_pozycji = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    opis = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    skladniki = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    image_data = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    kategoria_menuid = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    data_zamowienia = table.Column<DateTime>(type: "datetime2", nullable: false),
                    dodatkowe_informacje = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    status_zamowienia = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    laczna_cena = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    metoda_platnosci = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    opcje_zamowienia = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    alergenyid = table.Column<int>(type: "int", nullable: false),
                    pozycje_menuid = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    pozycja_menuid = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
